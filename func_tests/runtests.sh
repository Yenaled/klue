...
checkcmdoutput "$klue distinguish --bubble -p -k 7 -L left.fa -R right.fa -V V0.fa,V1.fa $test_dir/snp_x.fa $test_dir/snp_y.fa |wc -c|tr -d ' '" 4f0a1b818adede0bbb84feba8ba6ec72 
check_fasta_files "$o/klue_output/snp_xy_expected_L.fa" "$o/klue_output/snp_xy_expected_V0.fa" "$o/klue_output/snp_xy_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V0.fa" "$o/klue_output/right.fa"
check_fasta_files "$o/klue_output/snp_xy_expected_L.fa" "$o/klue_output/snp_xy_expected_V1.fa" "$o/klue_output/snp_xy_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V1.fa" "$o/klue_output/right.fa"

# Test using klue distinguish --bubble -k 7 snp_x.fa snp_y.fa snp_z.fa
checkcmdoutput "$klue distinguish --bubble -p -k 7 -L left.fa -R right.fa -V V0.fa,V1.fa,V2.fa $test_dir/snp_x.fa $test_dir/snp_y.fa $test_dir/snp_z.fa |wc -c|tr -d ' '" 0a94029f511a8de8bb2b1a0019c724d5 
check_fasta_files "$o/klue_output/snp_xyz_expected_L.fa" "$o/klue_output/snp_xyz_expected_V0.fa" "$o/klue_output/snp_xyz_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V0.fa" "$o/klue_output/right.fa"
check_fasta_files "$o/klue_output/snp_xyz_expected_L.fa" "$o/klue_output/snp_xyz_expected_V1.fa" "$o/klue_output/snp_xyz_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V1.fa" "$o/klue_output/right.fa"
check_fasta_files "$o/klue_output/snp_xyz_expected_L.fa" "$o/klue_output/snp_xyz_expected_V2.fa" "$o/klue_output/snp_xyz_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V2.fa" "$o/klue_output/right.fa"

# Test using klue distinguish --bubble -k 7 snp_insertion_x.fa snp_insertion_y.fa
checkcmdoutput "$klue distinguish --bubble -p -k 7 -L left.fa -R right.fa -V V0.fa,V1.fa $test_dir/snp_insertion_x.fa $test_dir/snp_insertion_y.fa |wc -c|tr -d ' '" e86e120cf501959497608f194718a65d  
check_fasta_files "$o/klue_output/snp_insertion_expected_L.fa" "$o/klue_output/snp_insertion_expected_V0.fa" "$o/klue_output/snp_insertion_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V0.fa" "$o/klue_output/right.fa"
check_fasta_files "$o/klue_output/snp_insertion_expected_L.fa" "$o/klue_output/snp_insertion_expected_V1.fa" "$o/klue_output/snp_insertion_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V1.fa" "$o/klue_output/right.fa"

# Test using klue distinguish --bubble -k 7 extendedvariation_x.fa extendedvariation_y.fa
checkcmdoutput "$klue distinguish --bubble -p -k 7 -L left.fa -R right.fa -V V0.fa,V1.fa $test_dir/extendedvariation_x.fa $test_dir/extendedvariation_y.fa |wc -c|tr -d ' '" 592657454184aa2def01fe6b8ae448b3 
check_fasta_files "$o/klue_output/extendedvariation_expected_L.fa" "$o/klue_output/extendedvariation_expected_V0.fa" "$o/klue_output/extendedvariation_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V0.fa" "$o/klue_output/right.fa"
check_fasta_files "$o/klue_output/extendedvariation_expected_L.fa" "$o/klue_output/extendedvariation_expected_V1.fa" "$o/klue_output/extendedvariation_expected_R.fa" "$o/klue_output/left.fa" "$o/klue_output/V1.fa" "$o/klue_output/right.fa"
