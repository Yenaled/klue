...
checkcmdoutput "$klue distinguish -t 1 -M 1,1 -p $test_dir/extendedvariation_x.fa $test_dir/extendedvariation_y.fa |wc -c|tr -d ' '" e42bb897d0afcdb1f1c46fb5e0c1ad22
