...
checkcmdoutput "$klue distinguish -t 1 -M 1,1 -p $test_dir/snp_x.fa $test_dir/snp_y.fa -L test_1_L.fa -R test_1_R.fa -V "test_1_var0.fa,test_1_var1.fa" |wc -c|tr -d ' '" e42bb897d0afcdb1f1c46fb5e0c1ad22
